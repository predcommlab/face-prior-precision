function [ceiling_upperBound, ceiling_lowerBound, bestFitRDM, RDMcorrs_LOO, meanRDM_corrs] ...
    = ceilingAvgRDMcorr(refRDMestimates,RDMcorrelationType,monitor)
...
function r=correlation(a,b,RDMcorrelationType)
    switch RDMcorrelationType
        ...
        otherwise
            r=corr(a(:),b(:),'type',RDMcorrelationType,'rows','complete');
    end
